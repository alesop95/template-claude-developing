...
Strumenti, documentazione e procedure vivono nel **template** del sistema di
progetto, nel pacchetto `agenti-terminale`, che e' la fonte di verita' e l'unica
cosa che sopravvive a una formattazione:
...
Il repository di **macchina** conserva invece cio' che riguarda solo questo
computer: la fotografia del suo stato, i valori compilati, e un punto d'ingresso
sottile che chiama la catena del template con i parametri di questa macchina.

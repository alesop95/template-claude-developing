...
4. Si completano gli stub restanti (`gap-analysis`, `skill-autogen`, e la parte di parsing di `deep-paper-reading`) alla luce delle scelte appena fatte, seguendo la sezione "Come completarla" di ciascun `SKILL.md`; `literature-search` e' gia' operativa da subito, con o senza MCP connessi.

...
1. Struttura e organizzazione: il codice è scritto al livello di astrazione giusto, senza over-engineering rispetto al task descritto? Le dipendenze tra moduli sono chiare?
...
3. Sicurezza: input esterni vengono validati ai confini del sistema? Ci sono credenziali, token o path hardcoded? L'output è soggetto a injection (SQL, XSS, command)?

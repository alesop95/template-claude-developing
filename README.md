...
7. Non serve toccare il gate: la skill `init-project-system` e i due prompt leggono `PACKAGES.md`, propongono il pacchetto quando il trigger è pertinente e ne mostrano il recap d'uso all'attivazione.
